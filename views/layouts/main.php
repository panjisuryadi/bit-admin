...
<html lang="en">
  ...
  <head>
    ...
    <!--begin::Third Party Plugin(Bootstrap Icons) / https://icons.getbootstrap.com/ -->
    <link
      rel="stylesheet"
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      if (!empty($main) && file_exists($main)) {
        ...
        echo "<p>View not found: {$main}</p>";
      }
    
      // global $main;
      // echo $main;
      // global $views;
      // $main = $views.'customers/lists.php';
      // include $main;
      ?>
